...
import { BarChart3, PieChart, Target, TrendingUp, Download, RefreshCw } from "lucide-react"
      ...
      <div className="md:ml-64">
        <main className="p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Topic Analysis</h1>
              <p className="text-muted-foreground text-lg">AI-powered analysis of your syllabus and question papers</p>
            </div>
